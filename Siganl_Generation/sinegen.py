...
class sinegen(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SInewave_Generation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SInewave_Generation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "sinegen")
...
def main(top_block_cls=sinegen, options=None):
