...
class FSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, firdes.low_pass(1.0,samp_rate,1000,400), center, samp_rate)
        ...
        self.blocks_vco_c_0 = blocks.vco_c(samp_rate, 15708, 0.5)
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0_0, 0), (self.iio_pluto_sink_0, 0))
        ...
        self.connect((self.blocks_vco_c_0, 0), (self.blocks_multiply_const_vxx_0_0_0, 0))
